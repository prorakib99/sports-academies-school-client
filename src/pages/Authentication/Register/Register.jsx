        ...
        <main className='lg:min-h-[70vh] dark:bg-slate-800 flex justify-center items-center'>
            <div className='py-14 lg:py-20'>
                <div className='container'>
                    <div
                        className={`flex justify-center items-center lg:w-[450px] mx-auto dark:bg-black/10 shadow-2xl dark:shadow-white/10 rounded-md ${
                            isLoading ? 'blur-sm' : ''
                        }`}
                    >
                                        ...
                                        <div className='mt-1 relative'>
                                            <div>
                                                ...
                                                {errors.password?.type === 'pattern' && (
                                                    <span className='dark:text-white text-red-500'>
                                                        Password must be a Capital latter and a
                                                        special character
                                                    </span>
                                                )}
                                            </div>
